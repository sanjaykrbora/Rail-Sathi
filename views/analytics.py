...
def app():
    ...
    coaches_sorted = coaches.sort_values(by="progress", ascending=False)
    ...
    progress_chart = px.bar(
        ...
        color="progress",
        text="progress",
        title="Coach-wise Progress (%)",
        color_continuous_scale="RdYlGn",
        labels={"coach_number": "Coach Number", "progress": "Progress (%)"}
    )
