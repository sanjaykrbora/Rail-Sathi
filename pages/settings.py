...
def app():
    ...
    st.caption(
        "Configure Rail Sathi application settings."
    )
...
single integrated platform.
    ...
    st.success(
        """
Developer : Shobhraj Bhattacharjee
...
• Plotly
    ...
    st.caption(
        "© 2026 Rail Sathi | Smart Railway Workshop Management System | Version 1.0 Enterprise"
    )
